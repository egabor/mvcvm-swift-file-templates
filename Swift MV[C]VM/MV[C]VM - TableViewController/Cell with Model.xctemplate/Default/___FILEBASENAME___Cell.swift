...
class ___FILEBASENAMEASIDENTIFIER___Cell: UITableViewCell, ReactiveBindable {
    ...
    let viewModel: ___FILEBASENAMEASIDENTIFIER___CellViewModel = ___FILEBASENAMEASIDENTIFIER___CellViewModel()
...
extension ___FILEBASENAMEASIDENTIFIER___Cell {
